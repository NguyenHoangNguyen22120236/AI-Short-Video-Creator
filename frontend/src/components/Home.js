        ...
        <div className='container p-1'>
            ...
            <div className='row p-3'>
                <div className='d-flex justify-content-start align-items-center gap-3 p-0'>
                    ...
                    <a href="/history-see-all" className="see-all">See all</a>
                </div>
                <div className="d-flex flex-wrap justify-content-between align-items-center p-0">
                    {videos.map((video) => (
                        <div className='col-lg-4 col-md-6 col-sm-6 col-6 p-lg-5 p-md-3 p-sm-3 p-2' key={video.video_id}>
                            <div className='card'>
                                <img src={video.thumbnail_url} alt={video.topic} className="thumbnail" />
                                <div className='d-flex justify-content-between align-items-center p-3'>
                                    <div>
                                        ...
                                        <h5>{formatDistanceToNow(new Date(video.created_at), { addSuffix: true })}</h5>
                                    </div>
